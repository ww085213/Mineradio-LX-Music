...
function readSavedLyricLayout() {
  ...
  try {
    ...
    return {
      ...
      sonicAdaptiveSongColor: raw.sonicGroundColorMode !== 'custom',
      ...
      sonicWorkshopAdaptiveSongColor: raw.sonicWorkshopAdaptiveSongColor !== false,
...
function currentFxAutosaveTouchedKeys(reason, payload) {
  ...
  var map = {
    ...
    sonicGroundColorAuto: ['sonicGroundColorMode', 'sonicAdaptiveSongColor', 'sonicGroundBaseColor', 'sonicGroundCoolColor', 'sonicGroundWarmColor', 'sonicGroundAccentColor'],
    ...
    sonicWorkshopRegionColors: ['sonicWorkshopAdaptiveSongColor', 'sonicWorkshopColorMode', 'sonicWorkshopTheme', 'sonicWorkshopCustomColor', 'sonicWorkshopBaseColorMode', 'sonicWorkshopBaseColor', 'sonicWorkshopWarmColorMode', 'sonicWorkshopWarmColor', 'sonicWorkshopCoolColorMode', 'sonicWorkshopCoolColor', 'sonicWorkshopRippleColorMode', 'sonicWorkshopRippleColor', 'sonicWorkshopPeakColorMode', 'sonicWorkshopPeakColor'],
...
function saveLyricLayout(opts) {
  ...
  try {
    ...
    var autosavePayload = {
      ...
      sonicAdaptiveSongColor: fx.sonicGroundColorMode !== 'custom',
      ...
      sonicWorkshopAdaptiveSongColor: fx.sonicWorkshopAdaptiveSongColor === true,
